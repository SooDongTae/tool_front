...
export const CategoryModal = ({ setData, data, category }: CateModalType) => {
  ...
  return (
    <>
      <div
        className={`w-[7rem] h-[2rem] shadow-[rgba(0,_0,_0,_0.08)_0px_0px_4px] flex flex-row justify-around items-center text-[0.9rem] ${
      ...
      {open ? (
        <div className="w-[10rem] absolute mt-[18rem] shadow-[rgba(0,_0,_0,_0.1)_0px_0px_8px_0px] bg-white z-10">
